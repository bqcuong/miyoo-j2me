...
public class Utils {
	...
	static public native void fillBuffer(FloatBuffer buffer, FloatBuffer vertices, int[] indices);

	static public native void transform(FloatBuffer srcVertices, FloatBuffer dstVertices,
								 FloatBuffer srcNormals, FloatBuffer dstNormals,
								 ByteBuffer boneMatrices, float[] actionMatrices);

	static public native void glReadPixels(int x, int y, int width, int height, /* Bitmap */ int[] bitmapBuffer,
									int bwidth, int bstride);
	static public native long getDisplay();
